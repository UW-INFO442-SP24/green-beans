        ...
        <div className="home">
            <div className="home-quiz">
                <div className="home-quiz-without-arrow">
                    <img src={quizImg} alt="aesthetic purple and green clothing" />
            ...
            <div className="home-stores">
                ...
                <div className="home-stores-without-title">
                    <img src={storesImg} alt="a vintage thrift shop" />
            ...
            <div className="home-events">
                ...
                <div className="home-events-without-title">
                    <img src={eventsImg} alt="a swap party event" />
            ...
            <div className="home-about">
                <img src={aboutImg} alt="a model with clothing over her head" />
